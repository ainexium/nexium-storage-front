              ...
              {editName ? (
                <div className="flex items-center gap-2 flex-1 justify-end">
                  ...
                  <button onClick={() => update.mutate({ name })} disabled={update.isPending}
                    className="px-2.5 py-1 rounded bg-[#9b3dff] hover:bg-[#aa55ff] disabled:opacity-40 text-xs font-medium transition-colors">{tc("save")}</button>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        maxLength={6}
                        className="w-36 px-2 py-1 rounded bg-white/[0.04] border border-white/[0.1] focus:border-[#9b3dff] outline-none text-sm font-mono tracking-widest transition-colors"
                      />
                      <button
                        onClick={() => confirmEmail.mutate()}
                        disabled={emailCode.length !== 6 || confirmEmail.isPending}
                        className="px-2.5 py-1 rounded bg-[#9b3dff] hover:bg-[#aa55ff] disabled:opacity-40 text-xs font-medium transition-colors"
                      >
                        {t("confirmChange")}
                      </button>
                      <button
