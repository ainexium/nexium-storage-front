          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                autoFocus
                className="w-full px-3 py-2.5 rounded-lg bg-gray-900 border border-gray-700 focus:border-[#007BFF] focus:ring-1 focus:ring-[#007BFF] outline-none text-sm transition"
              />
            </div>
            <div>
